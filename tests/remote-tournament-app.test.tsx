...
describe("STEP 13 remote read-only UI", () => {
  ...
  it("switches the remote display into scoreboard mode for passive TV viewing", async () => {
    ...
    expect(within(firstCourtCard).getByTestId("scoreboard-left-player-1")).toHaveAttribute("data-team-align", "toward-center");
    ...
    expect(within(firstCourtCard).getByTestId("scoreboard-left-player-2")).toHaveAttribute("data-team-align", "toward-center");
    ...
    expect(within(firstCourtCard).getByTestId("scoreboard-right-player-1")).toHaveAttribute("data-team-align", "toward-center");
    ...
    expect(within(firstCourtCard).getByTestId("scoreboard-right-player-2")).toHaveAttribute("data-team-align", "toward-center");
    expect(within(firstCourtCard).getByTestId("scoreboard-left-score")).toHaveTextContent("17");
    expect(within(firstCourtCard).getByTestId("scoreboard-left-score")).toHaveAttribute("data-score-align", "left-team-center");
    expect(within(firstCourtCard).getByTestId("scoreboard-right-score")).toHaveTextContent("7");
    expect(within(firstCourtCard).getByTestId("scoreboard-right-score")).toHaveAttribute("data-score-align", "right-team-center");
