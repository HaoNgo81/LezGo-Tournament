...
export { clearShadowSaveMetadata, createStandardShadowSaveLocalId, createTeamVsTeamShadowSaveLocalId, ensureStandardTournamentShadowSaveCompleted, ensureTeamVsTeamTournamentShadowSaveCompleted, isShadowSaveEnabled, loadAllShadowSaveMetadata, loadShadowSaveMetadata, markCloudTournamentRestored, markRemoteShadowSaveApplied, retryStandardTournamentShadowSave, retryTeamVsTeamShadowSave, shadowSaveMetadataChangedEvent, waitForShadowSaveCompletion } from "./shadow-save";
export { loadActiveCloudTournamentAuthority, markActiveCloudTournamentAuthority } from "./cloud-authority";
...
export type { CloudTournamentAuthority } from "./cloud-authority";
