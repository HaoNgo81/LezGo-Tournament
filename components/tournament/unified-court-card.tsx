...
const densityStyles: Record<UnifiedCourtCardDensity, {
  ...
  mobile: {
    ...
    score: "text-[3.4rem] sm:text-[4.05rem]",
    separator: "text-[2.1rem] sm:text-[2.75rem]",
  ...
  tv: {
    ...
    score: "text-[4rem] lg:text-[clamp(3.65rem,5.45vw,7.25rem)]",
    separator: "text-[2.75rem]",
  ...
  "scoreboard-large": {
    ...
    score: "text-[clamp(4.15rem,7.25vw,8.15rem)]",
    separator: "text-[clamp(2.15rem,3.6vw,4.3rem)]",
  ...
  "scoreboard-medium": {
    ...
    score: "text-[clamp(2.55rem,4.45vw,4.9rem)]",
    separator: "text-[clamp(1.6rem,2.7vw,3.15rem)]",
  ...
  "scoreboard-compact": {
    ...
    score: "text-[clamp(1.68rem,2.9vw,3.15rem)]",
    separator: "text-[clamp(1.04rem,1.8vw,2.1rem)]",
  ...
  "scoreboard-high": {
    ...
    score: "text-[clamp(1.32rem,2.25vw,2.5rem)]",
    separator: "text-[clamp(0.85rem,1.4vw,1.6rem)]",
